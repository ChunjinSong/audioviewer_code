...
def train(cfg, logger, local_rank, world_size, distributed):
    ...
    for epoch in range(0, cfg.TRAIN.TRAIN_EPOCHS): #(scheduler.start_epoch(), cfg.TRAIN.TRAIN_EPOCHS):
...
if __name__ == "__main__":
    ...
    run(train, get_cfg_defaults(), description='StyleSoftIntroVAE',
        default_config= '/local/chunjins/project/AudioViewer/style_soft_intro_vae/configs/celeba-hq256.yaml', #'./configs/celeba-hq256.yaml',  #celeba-hq256.yaml', ffhq256.yaml',
